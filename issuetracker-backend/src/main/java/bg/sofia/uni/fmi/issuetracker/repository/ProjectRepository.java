...
public interface ProjectRepository extends JpaRepository<Project, String> {
    ...
    @Query("select exists(select pu.id from ProjectUser pu where pu.project = :project and pu.user = :user and pu.id.role = :role)")
    boolean isUserInProject(@Param("user") User user, @Param("project") Project project, @Param("role") Role role);
    ...
    @Query("""
            ...
            """)
    boolean hasRoles(@Param("user") User user, @Param("project") Project project,
