...
public class Constants {
    ...
    public static final long DEFAULT_AUTH_TOKEN_VALIDITY = 10 * 60 * 1000; // 10 minutes
    public static final long DEFAULT_REFRESH_TOKEN_VALIDITY = 24 * 60 * 60 * 1000; // 24 hours
